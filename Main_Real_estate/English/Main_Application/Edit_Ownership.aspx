        ...
        <div class="row">
            <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <asp:RequiredFieldValidator ID="Req_Val_PIN_Number" ControlToValidate="txt_PIN_Number"
                                                runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="Red"></asp:RequiredFieldValidator>
                                            <asp:Label ID="Pin_No_Worrnig" runat="server" Visible="false" ForeColor="Red" Font-Size="13px"></asp:Label>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                ...
                <div class="row width">
                    ...
                    <div class="col-lg-1">
                        <asp:LinkButton ID="Delete_Ownership"  runat="server" ValidationGroup="Delete" OnClick="Delete_Ownership_Click" OnClientClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash" style="font-size:40px; color:#0779c9"></i></asp:LinkButton>
                    </div>
                    <div class="col-lg-5">
        ...
        <div class="row">
            ...
            <HeaderTemplate>
                <table cellspacing="0" style="width: 50%; font-size: 11px">
                    <thead>
                        <th>#</th>
                        <th style="text-align: center;"><asp:Label ID="lbl_Titel_Statment_FileName" runat="server" /></th>
                        <th style="text-align: center;"><asp:Label ID="lbl_Titel_Statment_Date" runat="server" /></th>
                        <th></th>
                    </thead>
                    <tbody>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <asp:LinkButton ID="Statment_delete" runat="server" OnClientClick="return confirm('Are you sure you want to delete?');" CommandArgument='<%# Eval("Statment_Id") %>' OnClick="Statment_delete_Click"><i class="fa fa-trash" style="font-size:18px;"></i></asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
