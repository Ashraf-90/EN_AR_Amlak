...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Buidling_Panel" runat="server" Visible="false" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="Req_Val_Ar_Bilding_Name" ControlToValidate="txt_Ar_Bilding_Name" ValidationGroup="Building_Req"
                                      ErrorMessage="* حقل مطلوب !!!"  runat="server"  ForeColor="#fc544b"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="Req_Val_En_Bilding_Name" ControlToValidate="txt_En_Bilding_Name" ValidationGroup="Building_Req"
                                      ErrorMessage="* حقل مطلوب !!!"  runat="server"   ForeColor="#fc544b"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="Building_Condition_Req_Val" ControlToValidate="Building_Condition_DropDownList" ValidationGroup="Building_Req"
                                        InitialValue="..............." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="Building_Type_Req_Val" ControlToValidate="Building_Type_DropDownList" ValidationGroup="Building_Req"
                                        InitialValue="..............." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="Building_Value_Req_Field_Val" ControlToValidate="txt_Building_Value" ValidationGroup="Building_Req"
                                        runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="ownership_Name_Req_Val" ControlToValidate="ownership_Name_DropDownList" ValidationGroup="Building_Req"
                                        InitialValue="..............." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="background-color: #015997; height: 190px; border-radius: 10px; margin-bottom: 10px">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group" style="text-align: center">
                                    <asp:Label ID="lbl_Street" runat="server" Text=" الشارع" ForeColor="White"></asp:Label>
        ...
        <div class="container-fluid" id="ATT_Building_container-wrapper">
            <div class="row">
                <div class="col-lg-12" style="border-style: solid; border-radius: 10px; width: 1221px;">
                    <h3><asp:Label ID="lbl_Building_File" runat="server"></asp:Label></h3>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
        ...
        <br />
        <div class="col-lg-12">
            <asp:Button ID="btn_Add_Building" runat="server" Text="إضافة البناء" CssClass="btn  mb-1" BackColor="#52a2da" ValidationGroup="Building_Req" ForeColor="White" OnClick="Btn_Add_Building_Click" />
            &nbsp;&nbsp;
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lbl_Success_Add_Building" runat="server" Font-Size="30px" ForeColor="#66bb6a" Visible="false"></asp:Label>
    ...
    <div class="col-lg-4">
        ...
        <asp:Button CssClass="btn  mb-1" BackColor="#C7FC9A" ID="Button4" runat="server" Text="إضافة بناء جديد "  ValidationGroup="X" Visible="false"  OnClick="Button4_Click" />
    </div>
    <br />
    ...
    <asp:Panel ID="Unit_Panel" runat="server" Visible="false" >
        <div class="container-fluid" id="Unit_container-wrapper">
            ...
            <div class="container-fluid" id="ATT_Unit_container-wrapper">
                <div class="row">
                    <div class="col-lg-12" style="border-style: solid; border-radius: 10px; width: 1221px;">
                        <h3><asp:Label ID="lbl_Unit_File" runat="server"></asp:Label></h3>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
        ...
        <div class="col-lg-6">
            <asp:Button ID="btn_Add_Unit" runat="server" Text="إضافة وحدة" CssClass="btn  mb-1" BackColor="#52a2da" ValidationGroup="Unit_RequiredField" ForeColor="White" OnClick="btn_Add_Unit_Click" />
            &nbsp;&nbsp;
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="lbl_Success_Add_Unit" runat="server" Font-Size="30px" ForeColor="#66bb6a" Visible="false"></asp:Label>
        </div>
    </asp:Panel>
</asp:Content>
