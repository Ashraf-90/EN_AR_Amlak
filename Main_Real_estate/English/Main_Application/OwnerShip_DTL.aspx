    ...
    <ul style="background-color: #efefef; min-height: 0px; width: 100%" class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
        <li class="nav-item" style="padding-bottom: 10px;" runat="server" id="Ownership_Div">
            <a class="nav-link" href="#" data-toggle="collapse" data-target="#M_Ownership" aria-expanded="true"
                ...
                <span style="font-size: 18px;"><asp:Label ID="lbl_Titel_Building_List" runat="server" Font-Size="18px"/></span>
            </a>
            <div id="M_Ownership" class="collapse show" aria-labelledby="headingForm" data-parent="#accordionSidebar">
                        ...
                        <asp:Repeater ID="building_List" runat="server" ClientIDMode="Static" OnItemDataBound="building_List_ItemDataBound">
                            <HeaderTemplate>
                                <table cellspacing="0" style="width: 100%; font-size: 11px" class="datatable table table-striped table-bordered Buidling_In_Ownership">
                                    <thead>
                                        <th>#</th>
                                        <th><asp:Label ID="lbl_Titel_Building_Arabic_Name" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></th>
                                        <th><asp:Label ID="lbl_Titel_Building_NO" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></th>
                                        <th><asp:Label ID="lbl_Titel_Construction_Area" Text='<%# Container.ItemIndex + 1 %>' runat="server" /> </th>
                                        <th><asp:Label ID="lbl_Titel_Maintenance_status" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></th>
                                        <th><asp:Label ID="lbl_Titel_Building_Condition" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></th>
                                        <th><asp:Label ID="lbl_Titel_Building_Type" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></th>
                                        <th><asp:Label ID="lbl_Titel_Building_Value" Text='<%# Container.ItemIndex + 1 %>' runat="server" /></th>
                            ...
                            <ItemTemplate>
                                <tr id="row" runat="server">
                                    ...
                                    <td>
                                        ...
                                        <asp:Label ID="Building_Id" runat="server" Visible="false" Text='<%# Eval("Building_Id") %>' /> </td>
                                    ...
                                    <td>
                                        <asp:Label ID="lbl_Building_Arabic_Condition" runat="server" Text='<%# Eval("Building_Arabic_Condition") %>' />
                                        <asp:Label ID="lbl_Building_Engils_Condition" runat="server" Text='<%# Eval("Building_English_Condition") %>' />
                                    </td>
                                    <td>
                ...
                <asp:Repeater ID="Repeater1" runat="server" ClientIDMode="Static" OnItemDataBound="Repeater1_ItemDataBound">
                    <ItemTemplate>
                        ...
                        <asp:Label Font-Size="25px" ID="lbl_Building_English_Name"  runat="server" Text='<%# Eval("Building_English_Name") %>'/>
                        <div class="container-fluid">
                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="Radios_Info">
                                                        ...
                                                        <asp:Label CssClass="Dtl" ID="lbl_Dtl_Building_English_Condition" runat="server" Text='<%# Eval("Building_English_Condition") %>' />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="Radios_Info">
                                                        ...
                                                        <asp:Label CssClass="Dtl" ID="lbl_Dtl_Building_English_Type" runat="server" Text='<%# Eval("Building_English_Type") %>' />
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="Radios_Info">
                                ...
                                <HeaderTemplate>
                                    <table cellspacing="0" style="width: 100%; font-size: 11px" class="datatable table table-striped table-bordered">
                                        <thead style="background-color: #d770ad; color: white">
                                            <th>#</th>
                                            <th><asp:Label ID="lbl_Titel_Unit_Number" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Titel_Unit_Space" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Titel_Floor_Number" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Titel_current_situation" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Unit_Type" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Unit_Condition" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Titel_virtual_Value" runat="server" /></th>
                                            <th><asp:Label ID="lbl_Unit_Detail" runat="server" /></th>
                                        </thead>
                                        <tbody>
                                </HeaderTemplate>
                                <ItemTemplate>
