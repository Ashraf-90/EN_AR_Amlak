...
{
    public partial class ENDashBoard : System.Web.UI.Page
    {
            ...
            //{
                ...
                //{
                    if (!this.IsPostBack)
                    {
                        ...
                        Ownership_Name_DropDownList.Items.Insert(0, "All Properties");
                        //****************************************************************************
                        Mounth_DropDownList.Items.Insert(0, "All Months");
        ...
        protected void DashBoard_Function()
        {
            ...
            if (Mounth_DropDownList.SelectedItem.Text == "All Months")
            {
                // 1-1
                if (Ownership_Name_DropDownList.SelectedItem.Text == "All Properties")
                {
                    ...
                    series.Points.Clear();
                    series.Points.Add(new Points("Vacant", double.Parse(Available)));
                    series.Points.Add(new Points("Rented", double.Parse(Rented)));
                    series.Points.Add(new Points("Under Construction Or Maintenance", double.Parse(Undermaintenance)));
                    series.Points.Add(new Points("There Is a Dispute", double.Parse(UnderProplem)));
                    series.Points.Add(new Points("", 0));
                    series.Points.Add(new Points("Expired", (U_C + B_C)));
                    ...
                    data.Add(new ColumnChartData("Expenses For All Properties", Convert.ToDouble(Management_Expenses_D_Y), Convert.ToDouble(RealEstate_Expenses_D_Y), Convert.ToDouble(Maintenance_Expenses_D_Y)));
                    ...
                    lbl_Real_Income.Text = "Actual Income";
                    ...
                    Real_Income_data.Add(new ColumnChartData("Actual Income", Convert.ToDouble(Collection_D_Y), Real_Income, total_Expensess));
                    ...
                    _sqlCon.Close();
                    // ********************************    التدفق النقدي **********************************
                    lbl_Cash_Flow.Text = "Cash flow for all properties for the year " + Year_DropDownList.SelectedItem.Text;
                    ...
                    data_Rental_Value.Add(new ColumnChartData("The rental value of all properties", Sum_virtual_Value, Total_Expected, Total_Income));
                    ...
                    Lbl_RealEstae.Text = "Return on real estate value";
                    Syncfusion.JavaScript.DataVisualization.Models.Series series4 = RealEstae_Chart.Series[0];
                    series4.Points.Clear();
                    series4.Points.Add(new Points("The annual income", Convert.ToDouble(Sum_Collection)));
                    series4.Points.Add(new Points("The value of the property", Convert.ToDouble(Sum_Bulidng_Value) + Convert.ToDouble(Sum_Land_Value)));
                    _sqlCon.Close();
                    ...
                    Label22.Text = "Annual depreciation for all properties";
                    Label23.Text = (Convert.ToDouble(Sum_Bulidng_Value) / Convert.ToDouble(txt_Destruction_Value.Text)).ToString("###,###,###");

                    Label24.Text = " The rest of the value of all properties";
                ...
                // 1-2
                else if (Ownership_Name_DropDownList.SelectedItem.Text != "All Properties" && Building_Name_DropDownList.SelectedItem.Text == "All Buildings")
                {
                    Building_Condition();
                    // **************************** النسب المئوية للجنسيات ********************************************************
                    percent_nationality_GridView();
                    ...
                    if (get_Building_Id_Dt.Rows.Count > 0)
                    {
                        for (int i = 0; i < get_Building_Id_Dt.Rows.Count; i++)
                        {
                            ...
                            Syncfusion.JavaScript.DataVisualization.Models.Series series = Units_Statuse.Series[0];
                            series.Points.Clear();
                            series.Points.Add(new Points("Vacant", Available));
                            series.Points.Add(new Points("Rented", Rented));
                            series.Points.Add(new Points("Under Construction Or Maintenance", Undermaintenance));
                            series.Points.Add(new Points("There is a dispute", UnderProplem));
                            series.Points.Add(new Points("", 0));
                            series.Points.Add(new Points("Expired", (U_C + B_C)));
                        }
                    }
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series Real_Income_series = Real_Income_Chart_2.Series[0];
                    List<ColumnChartData> Real_Income_data = new List<ColumnChartData>();
                    Real_Income_data.Add(new ColumnChartData("Actual Income", Convert.ToDouble(Collection_D_Y_O), Real_Income, total_Expensess));
                    this.Real_Income_Chart_2.DataSource = Real_Income_data;
                    this.Real_Income_Chart_2.DataBind();
                    _sqlCon.Close();
                    ...
                    _sqlCon.Close();
                    // ********************************    التدفق النقدي **********************************
                    lbl_Cash_Flow.Text = "Cash flow for all properties for the year " + Year_DropDownList.SelectedItem.Text + " والملكية   " + Ownership_Name_DropDownList.SelectedItem.Text;
                    _sqlCon.Open();
                    using (MySqlCommand Cash_flow_Cmd = new MySqlCommand("Dashboard_Test", _sqlCon))
                    {
                        Cash_flow_Cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    data_Rental_Value.Add(new ColumnChartData(Ownership_Name_DropDownList.SelectedItem.Text + " The rental value of the property ", Sum_virtual_Value, Total_Expected, Total_Income));
                    this.Rental_Value.DataSource = data_Rental_Value;
                    this.Rental_Value.DataBind();
                    _sqlCon.Close();
                    //****************************************************  القيمة القارية **********************************************************************************************************
                    ...
                    //*************************** الإهلاك **********************************************************************************************************************************
                    div_1.Visible = false; div_2.Visible = true;
                    Label22.Text = "Annual depreciation for all buildings in the property  :" + Ownership_Name_DropDownList.SelectedItem.Text;
                    Label23.Text = (Convert.ToDouble(Sum_Bulidng_Value) / Convert.ToDouble(txt_Destruction_Value.Text)).ToString("###,###,###");

                    Label24.Text = " The remainder of the value of all buildings in the propertyفي الملكية  :" + Ownership_Name_DropDownList.SelectedItem.Text;
                    Label25.Text = (Convert.ToDouble(Sum_Bulidng_Value) - Convert.ToDouble(Label23.Text)).ToString("###,###,###");
                ...
                else if (Ownership_Name_DropDownList.SelectedItem.Text != "All Properties" && Building_Name_DropDownList.SelectedItem.Text != "All Buildings")
                {
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series Real_Income_series = Real_Income_Chart_2.Series[0];
                    List<ColumnChartData> Real_Income_data = new List<ColumnChartData>();
                    Real_Income_data.Add(new ColumnChartData("Actual Income", Convert.ToDouble(Collection_D_Y_O_B), Real_Income, total_Expensess));
                    this.Real_Income_Chart_2.DataSource = Real_Income_data;
                    this.Real_Income_Chart_2.DataBind();
                    _sqlCon.Close();
                    //************************************* الربح الصافي **********************************************************
                    ...
                    _sqlCon.Close();
                    // ********************************    التدفق النقدي **********************************
                    lbl_Cash_Flow.Text = "Cash flow for all properties for the year " + Year_DropDownList.SelectedItem.Text + " والبناء   " + Building_Name_DropDownList.SelectedItem.Text;
                    _sqlCon.Open();
                    using (MySqlCommand Cash_flow_Cmd = new MySqlCommand("Dashboard_Test", _sqlCon))
                    {
                        Cash_flow_Cmd.CommandType = CommandType.StoredProcedure;
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series series5 = destruction_Char.Series[0];
                    series5.Points.Clear();
                    series5.Points.Add(new Points("Building Age", (Convert.ToDouble(Year) - Convert.ToDouble(Construction_Completion_Date))));
                    series5.Points.Add(new Points("remaining Age of the building", (Convert.ToDouble(txt_Destruction_Value.Text) - (Convert.ToDouble(Year) - Convert.ToDouble(Construction_Completion_Date)))));
                    _sqlCon.Close();
                    ...
                    lbl_Depreciation_percentage.Text = "percentage" + (((Convert.ToDouble(Label13.Text)) / (Convert.ToDouble(Label19.Text))) * 100).ToString("0.00") + "%";
                    //*************************** الإستدامة و  النمو **********************************************************************************************************************************
                    Real_Estate_Sustainability();
                }
            }
            else
            {
                ...
                if (Ownership_Name_DropDownList.SelectedItem.Text == "All Properties")
                {
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series series1 = Expenses_Chart.Series[0];
                    List<ColumnChartData> data = new List<ColumnChartData>();
                    data.Add(new ColumnChartData("Expenses For All Properties", Convert.ToDouble(Management_Expenses_D_Y_M), Convert.ToDouble(RealEstate_Expenses_D_Y_M), Convert.ToDouble(Maintenance_Expenses_D_Y_M)));
                    this.Expenses_Chart.DataSource = data;
                    this.Expenses_Chart.DataBind();
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series Real_Income_series = Real_Income_Chart_2.Series[0];
                    List<ColumnChartData> Real_Income_data = new List<ColumnChartData>();
                    Real_Income_data.Add(new ColumnChartData("Actual Income", Convert.ToDouble(Collection_D_Y_M), Real_Income, total_Expensess));
                    this.Real_Income_Chart_2.DataSource = Real_Income_data;
                    this.Real_Income_Chart_2.DataBind();
                    _sqlCon.Close();
                    //************************************* الربح الصافي **********************************************************
                ...
                else if (Ownership_Name_DropDownList.SelectedItem.Text != "All Properties" && Building_Name_DropDownList.SelectedItem.Text == "All Buildings")
                {
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series Real_Income_series = Real_Income_Chart_2.Series[0];
                    List<ColumnChartData> Real_Income_data = new List<ColumnChartData>();
                    Real_Income_data.Add(new ColumnChartData("Actual Income", Convert.ToDouble(Collection_D_Y_M_O), Real_Income, total_Expensess));
                    this.Real_Income_Chart_2.DataSource = Real_Income_data;
                    this.Real_Income_Chart_2.DataBind();
                    _sqlCon.Close();
                    //************************************* الربح الصافي **********************************************************
                    ...
                    // ********************************    التدفق النقدي **********************************
                    lbl_Cash_Flow.Text = "Cash flow for all properties for the year " + Year_DropDownList.SelectedItem.Text + " و البناء   " + Building_Name_DropDownList.SelectedItem.Text;
                    _sqlCon.Open();
                    using (MySqlCommand Cash_flow_Cmd = new MySqlCommand("Dashboard_Test", _sqlCon))
                    {
                        Cash_flow_Cmd.CommandType = CommandType.StoredProcedure;
                ...
                else if (Ownership_Name_DropDownList.SelectedItem.Text != "All Properties" && Building_Name_DropDownList.SelectedItem.Text != "All Buildings")
                {
                    ...
                    Syncfusion.JavaScript.DataVisualization.Models.Series Real_Income_series = Real_Income_Chart_2.Series[0];
                    List<ColumnChartData> Real_Income_data = new List<ColumnChartData>();
                    Real_Income_data.Add(new ColumnChartData("Actual Income", Convert.ToDouble(Management_Expenses_D_Y_M_O_B), Real_Income, total_Expensess));
                    this.Real_Income_Chart_2.DataSource = Real_Income_data;
                    this.Real_Income_Chart_2.DataBind();
                    _sqlCon.Close();
                    //************************************* الربح الصافي **********************************************************
        ...
        protected void Ownership_Name_DropDownList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Helper.LoadDropDownList("SELECT * FROM building where  Active != 0 and owner_ship_Owner_Ship_Id='" + Ownership_Name_DropDownList.SelectedValue + "'", _sqlCon, Building_Name_DropDownList, "Building_English_Name", "Building_Id");
            Building_Name_DropDownList.Items.Insert(0, "All Buildings");
            DashBoard_Function();
        }
        ...
        protected void Real_Estate_Sustainability()
        {
            ...
            if (D_Year == "2028")
            {
                ...
                series7.Points.Add(new Points("Total cumulative depreciation", destruction_2028));
                series7.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
            ...
            else if (D_Year == "2027")
            {
                ...
                Syncfusion.JavaScript.DataVisualization.Models.Series series7 = Chart7.Series[0];
                series7.Points.Clear();
                series7.Points.Add(new Points("Total cumulative depreciation", destruction_2027));
                series7.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
            ...
            else if (D_Year == "2026")
            {
                ...
                Syncfusion.JavaScript.DataVisualization.Models.Series series7 = Chart7.Series[0];
                series7.Points.Clear();
                series7.Points.Add(new Points("Total cumulative depreciation", destruction_2026));
                series7.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
            ...
            else if (D_Year == "2025")
            {
                ...
                Syncfusion.JavaScript.DataVisualization.Models.Series series7 = Chart7.Series[0];
                series7.Points.Clear();
                series7.Points.Add(new Points("Total cumulative depreciation", destruction_2025));
                series7.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
            ...
            else if (D_Year == "2024")
            {
                ...
                Syncfusion.JavaScript.DataVisualization.Models.Series series7 = Chart7.Series[0];
                series7.Points.Clear();
                series7.Points.Add(new Points("Total cumulative depreciation", destruction_2024));
                series7.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
            ...
            else
            {
                ...
                Syncfusion.JavaScript.DataVisualization.Models.Series series7 = Chart7.Series[0];
                series7.Points.Clear();
                series7.Points.Add(new Points("Total cumulative depreciation", destruction_2023));
                series7.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
            ...
            series6.Points.Add(new Points("Total real estate values", Sum_Land_Valuee + Building_Value));
        ...
        protected void Mortgage_All()
        {
            ...
            seriesM.Points.Add(new Points("The value of mortgaged property", Convert.ToDouble(Convert.ToDouble(X).ToString(""))));
            seriesM.Points.Add(new Points("Rate all properties", (Convert.ToDouble(All_Land_Value) + Convert.ToDouble(All_Building_Value)) - T));
            ...
            seriesM_2.Points.Add(new Points("paid amount", Convert.ToDouble(Amount_Paid)));
            seriesM_2.Points.Add(new Points("Remaining amount", Convert.ToDouble(Remaining_Amount)));
        ...
        protected void percent_nationality_GridView()
        {
            ...
            string Quary = "SELECT  T.Tenants_Arabic_Name ,  " +
                "TN.English_nationality , " +
                " COUNT(TN.English_nationality) 'عدد الجنسيات' , " +
                "  ((COUNT(TN.English_nationality) / '" + contract_Count + "') * 100)percent " +
                " FROM contract C " +
                ...
                " GROUP BY TN.English_nationality " +
                " HAVING COUNT(TN.English_nationality) > 0; ";
            DataTable Dt = new DataTable();
            ...
            {
                XPointMember[count] = ChartData.Rows[count]["English_nationality"].ToString();
            ...
            string Quary2 = "SELECT  T.Tenants_Arabic_Name ,  " +
                "TN.English_nationality , " +
                " COUNT(TN.English_nationality) 'عدد الجنسيات' , " +
                "  ((COUNT(TN.English_nationality) / '" + building_contract_Count + "') * 100)percent " +
                " FROM building_contract C " +
                "left join tenants T on(C.tenants_Tenants_ID = T.Tenants_Id) " +
                " left join nationality TN on(T.nationality_nationality_ID = TN.nationality_ID) " +
                " GROUP BY TN.English_nationality " +
            ...
            {
                XPointMember2[count] = ChartData2.Rows[count]["English_nationality"].ToString();
        ...
        protected void All_Building_Condition()
        {
            ...
            series5.Points.Clear();
            series5.Points.Add(new Points("New", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C1"].ToString())));
            series5.Points.Add(new Points("Follow up", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C2"].ToString())));
            series5.Points.Add(new Points("maintenance study", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C3"].ToString())));
            series5.Points.Add(new Points("maintenance study two", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C4"].ToString())));
            series5.Points.Add(new Points("exhausted", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C5"].ToString())));
            series5.Points.Add(new Points("not good", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C6"].ToString())));
            series5.Points.Add(new Points("Multi", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C7"].ToString())));
            _sqlCon.Close();
        }
        ...
        " (SELECT IF(All_Building_C7 != 0, All_Building_C7, 0))R_All_Building_C7 ";
            ...
            series5.Points.Add(new Points("Follow up", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C2"].ToString())));
            series5.Points.Add(new Points("maintenance study", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C3"].ToString())));
            series5.Points.Add(new Points("maintenance study اثنان", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C4"].ToString())));
            series5.Points.Add(new Points("exhausted", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C5"].ToString())));
            series5.Points.Add(new Points("not good", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C6"].ToString())));
            series5.Points.Add(new Points("Multi", Convert.ToDouble(VConstruction_Completion_Date_Dt.Rows[0]["R_All_Building_C7"].ToString())));
            _sqlCon.Close();
