    ...
    public partial class Collect_Multi_Cheuqe : System.Web.UI.Page
    {
        ...
        protected void Multi_Chueqe()
        {
            ...
            if (getMulti_ChueqeDataTable.Rows.Count > 0)
            {
                ...
                if (Session["Langues"].ToString() == "1") { txt_Bank_Name.Text = getMulti_ChueqeDataTable.Rows[0]["Bank_English_Name"].ToString(); }
                else { txt_Bank_Name.Text = getMulti_ChueqeDataTable.Rows[0]["Bank_Arabic_Name"].ToString(); }
                ...
                if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "محصل بالشيك" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "محصل بالتحويل" ||
                    ...
                    getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Collected By Cheque" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Collected By Transformation" ||
                    getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Collected By Cash" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Collected")
                {
                    ...
                    {
                        if (getMulti_ChueqeDataTable.Rows[0]["Collect_Type"].ToString() == "محصل بالشيك" || getMulti_ChueqeDataTable.Rows[0]["Collect_Type"].ToString() == "Collected By Cheque")
                        { Collect_Type_DropDownList.SelectedValue = "1"; }
                        else if (getMulti_ChueqeDataTable.Rows[0]["Collect_Type"].ToString() == "محصل نقداً" || getMulti_ChueqeDataTable.Rows[0]["Collect_Type"].ToString() == "Collected By Cash")
                        { Collect_Type_DropDownList.SelectedValue = "2"; }
                        else if (getMulti_ChueqeDataTable.Rows[0]["Collect_Type"].ToString() == "محصل بالتحويل" || getMulti_ChueqeDataTable.Rows[0]["Collect_Type"].ToString() == "Collected By Transformation")
                ...
                else
                {
                    ...
                    if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "مودع" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Deposited")
                    { Cheuqe_Status_DropDownList.SelectedValue = "1"; }
                    else if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "غير مودع" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Not Deposited")
                    { Cheuqe_Status_DropDownList.SelectedValue = "2"; }
                    else if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "مؤجل" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Delayed")
                    { Cheuqe_Status_DropDownList.SelectedValue = "5"; }
                    else if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "مرتجع" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Back")
                    { Cheuqe_Status_DropDownList.SelectedValue = "6"; }
                    else if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "مستبدل بالتحويل" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Replaced By Transformation")
                    { Cheuqe_Status_DropDownList.SelectedValue = "7"; }
                    else if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "مستبدل نقداً" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Replaced By Cash")
                    { Cheuqe_Status_DropDownList.SelectedValue = "8"; }
                    else if (getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "مستبدل بشيك اخر" || getMulti_ChueqeDataTable.Rows[0]["Cheques_Status"].ToString() == "Replaced By Onther Cheque")
