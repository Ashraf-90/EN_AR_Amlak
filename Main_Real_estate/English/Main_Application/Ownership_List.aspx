    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var table = $('.datatable').DataTable({
                ...
                language: { url: 'https://cdn.datatables.net/plug-ins/1.12.1/i18n/en.json'
                }
            });
        ...
        <div class="row" >
            <div class="col-lg-3 mb-3">
                <h1 class="h3 mb-0 text-gray-800">
                    <asp:Label ID="lbl_titel_Ownership_List" runat="server" ></asp:Label>
                </h1>
            </div>
            <div class="col-lg-3 mb-3">
            ...
            <div class="col-lg-12 mb-4">
                ...
                <HeaderTemplate>
                    <table cellspacing="0" style="width: 100%; font-size: 13px" class="datatable table table-striped table-bordered">
                        <thead>
                            ...
                            <th style="text-align: center; vertical-align: middle;"> <asp:Label ID="Titel_Zone" runat="server"/></th>
                            <th style="text-align: center; vertical-align: middle;"><asp:Label ID="Titel_Code" runat="server"/></th>
                            <th style="width: 200px;text-align: center; vertical-align: middle;"><asp:Label ID="Titel_Name" runat="server"/></th>
                            <th style="width: 100px; vertical-align: middle; text-align: center"><asp:Label ID="Titel_Owner" runat="server"/></th>
                            <th style="text-align: center; vertical-align: middle;"><asp:Label ID="Titel_BIN" runat="server"/></th>
                            <th style="text-align: center; vertical-align: middle;"><asp:Label ID="Titel_Area" runat="server"/></th>
                            <th style="text-align: center; vertical-align: middle;"><asp:Label ID="Titel_Bond_NO" runat="server"/></th>
                            <th style="text-align: center; vertical-align: middle;"><asp:Label ID="Titel_buildingCount" runat="server"/></th>
                            <th style="width: 269.712px; text-align: center; vertical-align: middle;"><asp:Label ID="Titel_Unit_Type" runat="server"/></th>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lbl_Owner_Arabic_name" runat="server" Text='<%# Eval("Owner_Arabic_name") %>' />
                            <asp:Label ID="lbl_Owner_English_name" runat="server" Text='<%# Eval("Owner_English_name") %>' />
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lbl_Unit_Type" runat="server" Text='<%# Eval("Unit_Type") %>' />
                            <asp:Label ID="lbl_EN_Unit_Type" runat="server" Text='<%# Eval("EN_Unit_Type") %>' />
                        </td>
                        ...
                        <td style="text-align: right">
                            <a href='<%# Eval("owner_ship_Certificate_Image_Path") %>' target="_blank" id="Link_Property_Scheme" style="font-size: 13px;">
                                ...
                                <asp:Label ID="lbl_Bonnd_Link" runat="server"></asp:Label>
                            </a>
                            <hr />
                            <a href='<%# Eval("Property_Scheme_Image_Path") %>' target="_blank" id="A1" style="font-size: 13px;">
                                ...
                                <asp:Label ID="lbl_Scheme_Link" runat="server"></asp:Label>
                            </a>
                        </td>
                        <td>
