                        ...
                        <HeaderTemplate>
                            <table  cellspacing="0" style="width: 100%; font-size:11px" id="Table" class="datatable table table-striped table-bordered">
                                <thead>
                                    ...
                                    <th><asp:Label ID="lbl_8" runat="server"/></th>
                                    <th><asp:Label ID="lbl_9" runat="server"/></th>
                                    <th><asp:Label ID="lbl_10" runat="server"/></th>
                                    <th><asp:Label ID="lbl_11" runat="server"/></th>
                                    <th></th>
                                </thead>
                            <tbody>
                        </HeaderTemplate>
