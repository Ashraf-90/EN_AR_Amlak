    ...
    public partial class Edit_transformation_Bank : System.Web.UI.Page
    {
        ...
        protected void language()
        {
            ...
            if (Dt.Rows.Count > 0)
            {
                ...
                {
                    lbl_titel_Edit_New_Bank.Text = Dt.Rows[210]["EN"].ToString();
                    btn_Edit_Bank.Text = Dt.Rows[57]["EN"].ToString();
                ...
                {
                    lbl_titel_Edit_New_Bank.Text = Dt.Rows[210]["AR"].ToString();
                    btn_Edit_Bank.Text = Dt.Rows[57]["AR"].ToString();
